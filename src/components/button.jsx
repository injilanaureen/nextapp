...
const Button = ({ children, href }) => {
  return (
      ...
      <button
        ...
        className="relative inline-block px-7 py-3 my-2 text-2xl font-bold text-white uppercase bg-gradient-to-br from-[#00c6ff] to-[#0072ff] rounded-full shadow-[0px_4px_0px_#0072ff] transition-all duration-200 ease-in-out cursor-pointer"
      >
        {children}
